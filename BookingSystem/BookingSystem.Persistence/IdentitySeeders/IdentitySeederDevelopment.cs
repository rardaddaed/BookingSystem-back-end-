...
{
  public class IdentitySeederDevelopment : BaseIdentitySeeder
  {
    public IdentitySeederDevelopment(ConfigurationDbContext configurationDbContext, string audience,
